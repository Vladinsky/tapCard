...
export default async (request: Request) => {
  ...
  } catch (error) { console.error('redirect_resolution_failed', error instanceof Error ? error.message : 'database error'); return response(503, 'Link temporarily unavailable') }
}
